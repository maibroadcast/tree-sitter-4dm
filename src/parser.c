...
enum {
  ...
  sym_variable = 71,
  sym_parameter = 72,
  aux_sym_source_code_repeat1 = 73,
  aux_sym_declaration_argument_list_repeat1 = 74,
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [11] = {
    [sym_declaration_argument_list] = STATE(33),
  ...
  [20] = {
    ...
    [aux_sym_array_declaration_arguments_token1] = ACTIONS(89),
    [aux_sym_identifier_token1] = ACTIONS(59),
  },
  [21] = {
  ...
  [23] = {
    [aux_sym_declaration_argument_list_repeat1] = STATE(19),
  ...
  [26] = {
    ...
    [sym_argument_separator] = ACTIONS(105),
  },
  [27] = {
    [anon_sym_LPAREN] = ACTIONS(107),
    [sym_command_suffix] = ACTIONS(107),
  },
  [28] = {
    [sym_identifier] = STATE(26),
    [aux_sym_identifier_token1] = ACTIONS(59),
  ...
  [32] = {
    ...
    [sym_command_suffix] = ACTIONS(109),
  },
  [33] = {
    [anon_sym_RPAREN] = ACTIONS(111),
  },
  [34] = {
    [sym_argument_separator] = ACTIONS(113),
  },
  [35] = {
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.count = 2, .reusable = true}, REDUCE(aux_sym_source_code_repeat1, 2), SHIFT_REPEAT(27),
  [20] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_code_repeat1, 2), SHIFT_REPEAT(27),
  [23] = {.count = 2, .reusable = true}, REDUCE(aux_sym_source_code_repeat1, 2), SHIFT_REPEAT(32),
  [26] = {.count = 2, .reusable = false}, REDUCE(aux_sym_source_code_repeat1, 2), SHIFT_REPEAT(32),
  ...
  [71] = {.count = 1, .reusable = false}, REDUCE(aux_sym_identifier_repeat1, 2),
  [73] = {.count = 2, .reusable = true}, REDUCE(aux_sym_identifier_repeat1, 2), SHIFT_REPEAT(16),
  [76] = {.count = 1, .reusable = false}, REDUCE(sym_identifier, 2),
  ...
  [85] = {.count = 1, .reusable = true}, REDUCE(sym_declaration_argument_list, 2),
  [87] = {.count = 1, .reusable = true}, SHIFT(13),
  ...
  [103] = {.count = 1, .reusable = true}, REDUCE(sym_declaration_argument, 1),
  [105] = {.count = 1, .reusable = true}, REDUCE(sym_variable, 2),
  [107] = {.count = 1, .reusable = true}, REDUCE(sym_array_type, 1),
  [109] = {.count = 1, .reusable = true}, REDUCE(sym_c_type, 1),
  [111] = {.count = 1, .reusable = true}, SHIFT(9),
  [113] = {.count = 1, .reusable = true}, SHIFT(12),
  [115] = {.count = 1, .reusable = true}, SHIFT(5),
  [117] = {.count = 1, .reusable = true},  ACCEPT_INPUT(),
};
